...
# Copyright (c) 2019 Sven Kreiensen
#
# Usage:
#
...
#
# make program = Flash the software hex file to the target device
#
...
install:
	...
	./teensy_loader_cli -v --mcu=$(MCU) -w $(TARGET).hex

# Remove all generated project files
clean: begin clean_files end
